...
@test "homes:preflight redacts GitHub tokens embedded in origin URLs" {
  ...
  run oikos_task homes:preflight test-agent --home "$home"
...
@test "homes:preflight fails when the home path is missing" {
  run oikos_task homes:preflight test-agent --home "$BATS_TEST_TMPDIR/missing-home"
...
@test "homes:preflight rejects invalid agent names" {
  ...
  run oikos_task homes:preflight "bad/agent" --home "$home"
