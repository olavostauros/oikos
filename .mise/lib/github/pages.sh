#!/usr/bin/env bash
# Shared helpers for oikos GitHub Pages custom-domain tasks.
#
...
_OIKOS_GITHUB_PAGES_LIB_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# shellcheck disable=SC1091 # dynamic repo-local source
source "$_OIKOS_GITHUB_PAGES_LIB_DIR/../common.sh"
